        ...
        <div>
            <section className="py-10 mt-14 bg-gradient-to-l rounded-3xl from-[#604DBC]  to-[#15E8BA] max-w-7xl mx-auto sm:py-16 ">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div data-aos="fade-left" data-aos-duration="1000" className="max-w-4xl mx-auto text-center">
                    ...
                    <form data-aos="fade-left" data-aos-duration="1000" action="#" method="POST" className="max-w-xl mx-auto mt-12">
