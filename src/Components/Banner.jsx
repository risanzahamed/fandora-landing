                ...
                <div className="relative  sm:pt-16 lg:py-20 xl:py-48">
                    ...
                    <div className="relative px-4 mx-auto sm:px-6 lg:px-24 max-w-[1440px]">
                        ...
                        <div   className=" mx-auto text-center lg:mx-0 lg:max-w-[1178px]  lg:text-left">
                            ...
                            <p data-aos="zoom-in"  data-aos-duration="1000" className="pt-48 max-w-[400px] lg:text-[25px] text-[20px] text-[#52C1B9] mt-6 lg:pt-10 lg:pb-6 lg:font-normal font-semibold">The World’s First Pre-NFT Rights  and Content Marketplace</p>

                            <div data-aos="zoom-in"  data-aos-duration="1000" className="mt-8 sm:mt-12">
                                <Link
                                    to='/now-live'
                                    aria-label='NOW LIVE'
                                    title='NOW LIVE'
                        ...
                        <div  className="lg:mt-60">
                            <p data-aos="zoom-in"  className=" lg:text-[25px] mt-20 text-center font-semibold z-40 text-[#52C1B9] lg:mt-6 lg:pt-10 lg:pb-6 lg:font-normal">Know about the launch before everyone else</p>


                            <div className="grid lg:grid-cols-2 mt-[43px]">
                                <div>
                                    <form data-aos="zoom-in"  data-aos-duration="1000" action="#" method="POST"  >
                                ...
                                <div data-aos="zoom-in"  data-aos-duration="1000" className="flex lg:mb-0 mb-10">
                                    ...
                                    <div className="flex lg:ml-8 justify-between">
                                        ...
                                        <img className="mr-2 lg:ml-0 ml-4 w-[43.74px] lg:mt-0 mt-4  lg:h-auto h-[42.03px]  lg:w-[75.74px]" src={google} alt="" srcSet="" />
